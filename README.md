...
```
cd existing_repo
git remote add origin https://gitlab.com/thomasd.codes/docker-symfony-stack.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/thomasd.codes/docker-symfony-stack/-/settings/integrations)
